...
#   test <- window(unadjusted.ts, start=start.test, end=end.test)
#   fit.arima = auto.arima(train)
#   forecast.arima <- forecast(fit.arima, h=12)
#   print(length(forecast.arima))
#   print(length(test))
#   length(forecast.arima[['mean']] - test)
#   mae[i,1:length(test)] <- abs(forecast.arima[['mean']]-test)
# } 
# 
# 
#   start.train <- 1 + 5/12
#   end.train <- 2
#   end.test <- 3
#   train <- window(unadjusted.ts, end=2)
#   test <- window(unadjusted.ts, start=start.test, end=end.test)
#   fit.arima = auto.arima(train)
#   forecast.arima <- forecast(fit.arima, h=12)
#   print(length(forecast.arima))
...
# 
#   print(i)
#   xshort <- window(unadjusted.ts,end=i+k*i)
#   print(length(xshort))
# }
# 
#   xnext <- window(unadjusted.ts,start=i+1,end=i+k)
